...
class BasicTransformerBlock(nn.Module):
    ...
    def _forward(self, x, context=None):
        # No residual connections (as in original SeD code)
...
class ModifiedSpatialTransformer(nn.Module):
    """SeFB: Semantic-aware Fusion Block.

    x = semantic features (first arg), context = image features (second arg).
    Cross-attention: Q from semantic, K/V from image.
    Output is pixel-shuffle upsampled to match image feature spatial size.
    """
